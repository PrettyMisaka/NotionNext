...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PrettyMisaka', // 您的昵称 例如 PrettyMisaka
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://prettymisaka.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '281562996@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/PrettyMisaka', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PATH:
    'https://npm.elemecdn.com/prism-themes/themes/prism-one-light.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  ...
  FIREWORKS_COLOR: ['34, 40, 49', '57, 62, 70', '00, 173, 181', '238, 238, 238'],
